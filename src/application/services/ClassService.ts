...
import { PromoteStudentsUseCase } from "../usecases/PromoteStudentsUseCase";
...
export class ClassService {
    constructor(
        ...
        private promoteStudentsUseCase: PromoteStudentsUseCase
    ) { }
    ...
    async promoteStudents(studentIds: string[], targetClassId: string): Promise<number> {
        return this.promoteStudentsUseCase.execute(studentIds, targetClassId);
    }
}
